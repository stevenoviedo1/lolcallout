...
export const CHAMP_KITS: Record<string, ChampKit> = {
  ...
  zed: {
    ...
    watchFor: ["zhonya", "hard CC", "1v3 greed", "R unlocked at 6"],
  ...
  malphite: {
    name: "Malphite",
    role: "Top / engage tank",
    combos: ["R flash into team → Q slow", "E AS shred in melee"],
    identity: "Ult engage tank — R wins teamfights.",
    playFor: ["flash R on carries", "side TP flank", "tower dive with R"],
    watchFor: ["R available after 6", "walking grouped for free R"],
    early: "Farm armor; look R all-in at 6.",
  },
  amumu: {
    name: "Amumu",
    role: "Jungle engage",
    combos: ["Q bandage → R curse → W", "flash R"],
    identity: "AoE ult engage jungler.",
    playFor: ["R on clustered team", "obj starts", "Q picks"],
    watchFor: ["ult unlocked teamfight", "walking stacked for free R"],
    early: "Full clear into gank; R only with follow-up.",
  },
  rammus: {
    name: "Rammus",
    role: "Jungle tank",
    combos: ["Q roll → E taunt → W", "R in big fights"],
    identity: "Taunt engage and AD shred.",
    playFor: ["taunt carries", "obj tank", "powerball ganks"],
    watchFor: ["Q engage angles", "taunt on ADC"],
    early: "Fast clear; gank lanes that shove.",
  },
  lux: {
    name: "Lux",
